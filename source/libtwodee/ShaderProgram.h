...
class ShaderProgram {
  public:
    ...
    /**
     Creates a shader program using the shader code in the specified files.
     Do not invoke this constructor without an active OpenGL context.
     ...
     */
    /* ShaderProgram(const char *vertex_path, */
                  /* const char *fragment_path, */
                  /* const char *geo_path = NULL, */
                  /* const char *outputs[] = NULL); */

    /**
     Creates a shader program shaded using the specified shader code.  Do not
     invoke this constructor without an active OpenGL context.
     @param vertex_source Vertex shader source
     @param fragment_source Fragment shader source
     @param geo_source Geometry shader source
     @param outputs Names of fragment shader output variables
     */
